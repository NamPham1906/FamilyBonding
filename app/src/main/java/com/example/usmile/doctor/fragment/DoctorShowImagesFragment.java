...
import com.example.usmile.doctor.adapter.DoctorShowImagesAdapter;
...
public class DoctorShowImagesFragment extends Fragment {

    RecyclerView imageRecyclerView;

    PreferenceManager preferenceManager;
    List<String> imagesList;
    DoctorShowImagesAdapter adapter;
    ...
    private void initRecyclerViewForShowImages() {
        ...
        adapter = new DoctorShowImagesAdapter(imagesList);
